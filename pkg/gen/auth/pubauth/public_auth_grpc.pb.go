...
const (
	Auth_Login_FullMethodName          = "/auth_pub.Auth/Login"
	Auth_Refresh_FullMethodName        = "/auth_pub.Auth/Refresh"
	Auth_Logout_FullMethodName         = "/auth_pub.Auth/Logout"
	Auth_UpdatePassword_FullMethodName = "/auth_pub.Auth/UpdatePassword"
)
...
func (c *authClient) UpdatePassword(ctx context.Context, in *UpdatePasswordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedAuthServer) UpdatePassword(context.Context, *UpdatePasswordRequest) (*emptypb.Empty, error) {
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "auth/public_auth.proto",
}
